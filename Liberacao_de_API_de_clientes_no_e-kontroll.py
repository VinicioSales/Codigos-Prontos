...
#Logando
navegador.find_element(By.XPATH,'/html/body/div/div/section/form/div[1]/input').send_keys('consultoria.britoesantana')
time.sleep(1)
navegador.find_element(By.XPATH,'/html/body/div/div/section/form/div[2]/input').send_keys('parceiro2021')
time.sleep(1)
